...
## Corpus Check
- 271 files · ~50,208 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1200 nodes · 1982 edges · 124 communities (82 shown, 42 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 285 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1c91ee39`
...
Cohesion: 0.06
Nodes (8): Node, JobArtifactRepository, JobArtifactService, JobStateMachine, LeaseWorker, none(), stop(), NomadEventStreamListener
...
Cohesion: 0.06
Nodes (55): ibmPlexMono, ibmPlexSans, metadata, RootLayout(), Header(), HeaderProps, LogoutButton(), ThemeProvider() (+47 more)
...
Cohesion: 0.16
Nodes (15): AdminDashboardPage(), fetchNodes(), getCountByStatus(), metadata, NodesResult, HomeDashboardSkeleton(), getRequiredAccessToken(), Card() (+7 more)
...
Cohesion: 0.09
Nodes (5): OutboxMessageHandler, EventConsumerDedupeService, FairQueueDispatcherService, JobAdmissionWorker, usageRatio()
...
Cohesion: 0.05
Nodes (55): ArtifactDownloadResponse, BackendProblem, buildFileName(), GET(), Params, ArtifactDownloadResponse, GET(), Params (+47 more)
...
Cohesion: 0.18
Nodes (15): FieldRowProps, formatDateForUser(), formatRamGb(), NodeDetailsPanel(), NodeDetailsProps, NodeDetails, metadata, NodeDetailPage() (+7 more)
...
Cohesion: 0.26
Nodes (9): formatCountdown(), formatDateForUser(), formatHeartbeat(), NodesList(), NodesListProps, NodeSummary, metadata, NodesPage() (+1 more)
...
## Knowledge Gaps
- **232 isolated node(s):** `name`, `private`, `prepare`, `workspaces`, `husky` (+227 more)
...
- **Why does `cn()` connect `Community 2` to `Community 10`, `Community 12`, `Community 28`, `Community 7`?**
