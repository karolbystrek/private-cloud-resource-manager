...
#   sh scripts/supabase/generate-keys.sh              # Interactive: prints keys, prompts to update .env
#   sh scripts/supabase/generate-keys.sh --update-env # Prints keys and writes them to .env
#   sh scripts/supabase/generate-keys.sh | tee keys   # Non-interactive: prints keys only
#
