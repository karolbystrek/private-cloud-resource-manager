...
CREATE INDEX idx_quota_reservations_job_id ON quota_reservations (job_id);

CREATE UNIQUE INDEX uq_quota_reservations_active_job ON quota_reservations (job_id)
    WHERE status = 'ACTIVE';
